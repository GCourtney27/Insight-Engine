...
namespace Insight {
	...
	{
	public:
		bool Init(ComPtr<ID3D11Device>& pDevice, const std::wstring& ShaderPath, D3D11_INPUT_ELEMENT_DESC* pLayoutDesc, UINT NumElements);
	...
	{
	public:
		bool Init(ComPtr<ID3D11Device>& pDevice, const std::wstring& Shaderpath);
