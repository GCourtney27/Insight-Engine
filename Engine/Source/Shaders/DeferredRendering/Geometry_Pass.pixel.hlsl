...
PS_OUTPUT_GEOMPASS main(PS_INPUT_GEOMPASS ps_in)
{
    ...
    ps_out.roughnessMetallicAO.b = t_AOObject.Sample(s_LinearWrapSampler, ps_in.texCoords).r + roughnessAdditive;
    ps_out.roughnessMetallicAO.r = t_RougnessObject.Sample(s_LinearWrapSampler, ps_in.texCoords).r + metallicAdditive;
