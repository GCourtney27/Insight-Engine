...
#include "Retina/Systems/Frame_Timer.h"
#include "Retina/Core/Layer/Layer_Stack.h"

#include "Retina/Events/Application_Event.h"

#include "Retina/Layer_Types/Game_Layer.h"
#include "Retina/Layer_Types/ImGui_Layer.h"
#include "Retina/Layer_Types/Editor_Layer.h"


namespace Retina {


	class RETINA_API Application
	{
	public:
		Application();
		virtual ~Application();
		...
		RN_STRIP_FOR_GAME_DIST(inline EditorLayer& GetEditorLayer() { return *m_pEditorLayer; })
	...
	protected:
		...
		RN_STRIP_FOR_GAME_DIST( ImGuiLayer* m_pImGuiLayer = nullptr; )
		RN_STRIP_FOR_GAME_DIST( EditorLayer* m_pEditorLayer = nullptr; )
