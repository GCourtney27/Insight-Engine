...
namespace Retina {
	...
	namespace Runtime {
		...
		class RETINA_API AActor : public SceneNode
		{
		public:
		...
		public:
			...
			ComponentType* CreateDefaultSubobject()
			{
				...
				RN_CORE_ASSERT(Component, "Trying to add null component to actor.");

				Component->OnAttach();
				Component->SetEventCallback(RN_BIND_EVENT_FN(AActor::OnEvent));
