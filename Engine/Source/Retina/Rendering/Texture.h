...
namespace Retina {
	...
	public:
		Texture(RN_TEXTURE_INFO CreateInfo)
		...
		inline const RN_TEXTURE_INFO& GetTextureInfo() const { return m_TextureInfo; }
	...
	protected:
		RN_TEXTURE_INFO	m_TextureInfo = {};
	};

	using RN_TEXTURE_INFO = Texture::RN_TEXTURE_INFO;
}