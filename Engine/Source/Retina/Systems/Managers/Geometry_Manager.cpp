...
namespace Retina {
	...
	{
		RN_ASSERT(!s_Instance, "An instance of Geometry Manager exists!");
		...
		default:
		{
			RN_CORE_FATAL(L"Failed to determine graphics api to initialize geometry manager. The render may have not been initialized properly or may not have been initialized at all.");
			break;
		}
		}
