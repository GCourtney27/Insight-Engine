...
namespace Insight {
	...
	public:
		...
		inline void RegisterScript(GameFramework::CSharpScriptComponent* Script) { m_RegisteredScripts.push_back(Script); }
		void UnRegisterScript(GameFramework::CSharpScriptComponent* Script);
	...
	private:
		...
		std::vector<GameFramework::CSharpScriptComponent*> m_RegisteredScripts;
	};
