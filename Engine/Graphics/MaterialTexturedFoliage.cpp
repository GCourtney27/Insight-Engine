...
bool MaterialTexturedFoliage::InitializeJOSNPiplineAssets(const rapidjson::Value & assetsInformation)
{
	...
	m_newVertOffset.x = 1.0f;
	m_newVertOffset.y = 1.0f;
...
{
	std::string tex_albedo = "..\\Assets\\Objects\\GrassClumps\\GrassClumps_Albedo.jpg";
	std::string tex_normal = "..\\Assets\\Objects\\GrassClumps\\GrassClumps_Normal.jpg";
	std::string tex_opacity = "..\\Assets\\Objects\\GrassClumps\\GrassClumps_Opacity.jpg";
	std::string tex_roughness = "..\\Assets\\Objects\\GrassClumps\\GrassClumps_Roughness.jpg";
	std::vector<std::string> textures;
