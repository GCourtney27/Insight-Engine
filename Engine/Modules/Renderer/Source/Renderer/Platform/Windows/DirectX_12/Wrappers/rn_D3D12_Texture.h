...
namespace Retina {
	...
	class RETINA_API ieD3D12Texture : public Texture
	{
	public:
		typedef UINT32 SRVHeapIndex;

	public:
		ieD3D12Texture(RN_TEXTURE_INFO createInfo, CDescriptorHeapWrapper& srvHeapHandle);
	...
	private:
		...
		bool Init(RN_TEXTURE_INFO createInfo, CDescriptorHeapWrapper& srvHeapHandle);
