...
void Player::InitializeCamera(Scene* scene)
{
	...
	m_pCamera->SetProjectionValues(75.0f, static_cast<float>(1600) / static_cast<float>(900), 0.1f, 4000.0f);
	...
	m_pCamera->GetTransform().SetPosition(DirectX::XMFLOAT3(-1.5f, 15.2f, -73.9f));// Game
