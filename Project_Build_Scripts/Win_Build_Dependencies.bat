...
echo ***************************************** & echo.
%~dp0..\Vendor\CMake\bin\cmake.exe %~dp0Engine\vendor\assimp-3.3.1
echo ***************************************** & echo.
echo Compiling assimp source code & echo.
echo ***************************************** & echo.
call %~dp0..\Dependency_Build_Scripts\Compile_Assimp.bat
...
echo ***************************************** & echo.
call %~dp0..\Dependency_Build_Scripts\Compile_DirectX_12_TK.bat

REM Build DirectX 12 Texture Tools
echo ***************************************** & echo.
echo Compiling DirectX 12 Texture Tools source code & echo.
echo ***************************************** & echo.
call %~dp0..\Dependency_Build_Scripts\Compile_DirectX_12_Tex.bat

REM Build DirectX 11 Tool Kit (TK)
echo ***************************************** & echo.
echo Compiling DirectX 11 Tool Kit source code & echo.
echo ***************************************** & echo.
call %~dp0..\Dependency_Build_Scripts\Compile_DirectX_11_TK.bat
