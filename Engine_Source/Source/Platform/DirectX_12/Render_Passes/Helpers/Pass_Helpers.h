	...
	*/
	...
	public:
		...
		inline void Create(
			...
			ComPtr<ID3D12Resource> pSourceUAV, D3D12_GPU_DESCRIPTOR_HANDLE hSourceUAV,				//9
			ComPtr<ID3D12Resource> pSourceSRV, D3D12_GPU_DESCRIPTOR_HANDLE hSourceSRV,				//10
			ComPtr<ID3D12Resource> pIntermediateUAV, D3D12_GPU_DESCRIPTOR_HANDLE hIntermediateUAV,	//11
			ComPtr<ID3D12Resource> pIntermediateSRV, D3D12_GPU_DESCRIPTOR_HANDLE hIntermediateSRV	//12
		)
		{
			m_pCommandListRef	= pCommandList;
