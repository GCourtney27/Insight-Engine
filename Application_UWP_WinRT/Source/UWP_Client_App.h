...
namespace SandBoxApp {
	...
	private:
		...
		void Norway()
		{
			...
			pHouseSupports->SetPosition(-30.5f, -28.65f, 88.45f);
			pHouseSupports->SetRotation(0.0f, 1.55f, 0.0f);
			pHouseSupports->SetScale(40.0f, 40.0f, 40.0f);
			// Foliage Supports
			...
			pPatio->SetPosition(-47.85f, -36.15f, 108.9f);
			pPatio->SetRotation(0.0f, 1.55f, 0.0f);
			pPatio->SetScale(50.0f, 50.0f, 50.0f);
			...
			pFrontRocks->SetRotation(1.5f, 0.0f, 0.0f);
		...
		void FillScene()
		{
			...
			// Bamboo Cube
			AActor* pABambooBall = new AActor(0, "Bamboo Cube");
			...
			pSMBall->AttachMesh("Models/Cube.fbx");
